    ...
    $faq = [
        ...
        [
            ...
            'answer' => "<p>I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web. 
                            ...
                            contattare il webmaster del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica. 
        ...
        [
            ...
            'answer' => "<p>In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google,
                            ...
                            ricerca criptata di Google), nella maggior parte dei casi i termini di ricerca non vengono inviati come parte dell'URL 
                            negli URL referrer. Questo comportamento può fare eccezione, ad esempio se utilizzi alcuni browser meno diffusi. 
                            Ulteriori informazioni sulla ricerca SSL sono disponibili qui. Le query di ricerca o le informazioni contenute nell'
                            URL referrer potrebbero essere disponibili mediante Google Analytics o un'API (Application Programming Interface).
...
<body>
    ...
    <main class="faq-container">
        <!-- <?php
            foreach($faq as $faqs){
            //var_dump($faqs['answer']);
            $sentences = preg_split('/[\.]+/', $faqs['answer']);
            // var_dump($sentences);
            echo '<h1>' .$faqs['question']. '</h1>';
            for ($i=0; $i < count($sentences); $i++) { 
                echo '<p class="paragraph">' .$sentences[$i]. '</p>';
            }
        }
        ?> -->
        <?php 
            foreach($faq as $faqs) {
                echo '<h1>' .$faqs['question']. '</h1>';
                echo '<p class="paragraph">' .$faqs['answer']. '</p>';
            }
            ?>
    </main>
</body>
